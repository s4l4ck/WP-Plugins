	...
	class TIELABS_ADVERTISMENT {
		...
		function left_right_ads(){
			...
			?>
				...
				<div class="side-stream" id="side-stream-right" style="display:none; z-index:108; position:absolute; text-align:center; top:0px; width:<?php echo tie_get_option( 'side_e3lan_right_width', 200 ) ?>px;<?php echo ( tie_get_option( 'side_e3lan_right_height' ) ) ? 'height:'. tie_get_option( 'side_e3lan_right_height' ).'px;':''?> overflow:hidden;"><?php echo do_shortcode( tie_get_option( 'side_e3lan_right_code' ) ); ?> </div>
				<div class="side-stream" id="side-stream-left"  style="display:none; z-index:108; position:absolute; text-align:center; top:0px; width:<?php echo tie_get_option( 'side_e3lan_left_width',  200 ) ?>px;<?php echo ( tie_get_option( 'side_e3lan_left_height'  ) ) ? 'height:'. tie_get_option( 'side_e3lan_left_height'  ).'px;':''?> overflow:hidden;"><?php echo do_shortcode( tie_get_option( 'side_e3lan_left_code' ) ); ?> </div>
			<?php
		}
