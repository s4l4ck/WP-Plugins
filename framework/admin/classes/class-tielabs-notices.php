	...
	class TIELABS_NOTICES {
		...
		function load_notices(){
			...
			if ( $theme_pages == 'toplevel_page_tie-theme-options' ){
				...
				add_action( 'admin_notices', array( $this, 'rate_theme_version_6' ), 115 );
		 ...
		 * Rate V5
		 */
		function rate_theme_version_6(){

			$notice_id = 'tie_bigupdate_date_6_'. TIELABS_THEME_ID;
		...
		if( ! get_option( $notice_id ) ){
				...
				$notice_content  = '<h4 style="color: #e24b17; font-size: 26px;">'. esc_html__( 'Biggest Update Ever', TIELABS_TEXTDOMAIN ) .'</h4>';
				...
				$notice_content .= '<a href="'. tie_get_purchase_link( array( 'utm_medium' => 'rate-v6' ) ) .'" target="_blank" style="background-color: #e24b17; border:none; font-size: 20px; margin: 0 10%; width: 80%; text-align:center;" class="button button-primary button-hero">'. esc_html__( 'Leave a Review on ThemeForest', TIELABS_TEXTDOMAIN ) .'</a>';

				echo '<div id="tie-page-overlay" class="is-notice-dismissible" data-id="'. $notice_id .'" style="bottom: 0; opacity: 0.8;"></div>';

				self::message( array(
					'notice_id' => $notice_id,
					'title'     => '<img style="max-width: 300px;" src="'. TIELABS_TEMPLATE_URL .'/framework/admin/assets/images/jannah-6.png" />',
					'message'   => $notice_content,
					'class'     => 'sucess tie-popup-block tie-popup-window tie-notice-popup tie-yay',
				));
			}
		...
		function rate_theme(){
			...
			// An Update
				...
				if( ! get_option( $install_date ) ){
					...
					$notice_content .= '<p style="font-size: 16px; margin-bottom: 10px; font-weight: bold;">'. esc_html__( 'We hope you love the new features and improvements, We\'d be thrilled if you could rate Jannah 5 stars &#x2b50;&#x2b50;&#x2b50;&#x2b50;&#x2b50; on ThemeForest, that will help us a lot on improving our items and the support as well.', TIELABS_TEXTDOMAIN ) .'</p>';
					$notice_content .= '<p style="font-size: 15px; margin-bottom: 25px;">'. esc_html__( 'Thank you in advance for your collaboration. We really appreciate your time!', TIELABS_TEXTDOMAIN ) .'</p>';
					$notice_content .= '<a href="'. tie_get_purchase_link( array( 'utm_medium' => 'rate-v6-new' ) ) .'" target="_blank" style="background-color: #e24b17; border:none; font-size: 20px; margin: 0 10%; width: 80%; text-align:center;" class="button button-primary button-hero">'. esc_html__( 'Leave a Review on ThemeForest', TIELABS_TEXTDOMAIN ) .'</a>';
